<?php
    ...
    function reset_pass($pass1,$email){
        $query="update add_emp set pass='$pass1' where email='$email'";
            ...
            <fieldset>
                ...
                <table align="center">
                    ...
                    <td>
                        ...
                        <td>
                            :<input type="text" name="phn" value="<?php echo $phn?>" placeholder="Enter Your Phone Number">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            :<input type="text" name="password" value="<?php echo $pass?>" placeholder="Enter New Password">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            :<input type="text" name="pass1" value="<?php echo $pass1?>" placeholder="Re-enter New Password">
                        </td>
                        <td>
